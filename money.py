...
principle_label=Label(window, text="Principle in Rs", fg = "black", bg = "lightgreen", font=("Calibri", 12),bd=1)
principle_label.place(x=20, y=92)

principle=Entry(window, text="", bd=2, width=22)
principle.place(x=200, y=92)

rate_label=Label(window, text="Rate of Interest in %", fg = "black", bg = "lightgreen", font=("Calibri", 12))
rate_label.place(x=20, y=140)

rate=Entry(window, text="", bd=2, width=15)
rate.place(x=200, y=142)

time_label=Label(window, text="Time in Yrs", fg = "black", bg = "lightgreen", font=("Calibri", 12))
time_label.place(x=20, y=185)

time=Entry(window, text="", bd=2, width=15)
time.place(x=200, y=187)

calculate_button=Button(window,text="CALCULATE",fg = "black", bg = "green",bd=4,command=calculate_interest)
...
result=Label(result_frame,text="Your result will be displayed here", bg = "lightgreen", font=("Calibri", 12), width=55)
